...
class LoadPackageData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $package1->setLink( '/admin/article' );
        ...
        $package2->setLink( '/admin/sonata/media/media' );
        ...
        $package4->setLink( '/admin/template' );
        ...
        $package7->setLink( '/admin/category' );
        ...
        $package8->setLink( '/admin/sonata/user/group' );
        ...
        $package9->setLink( '/admin/sonata/user/user' );
        ...
        $package16->setLink( '/admin/domain' );
        //$package16->setHasUniquePartPackage( 1 );
        ...
        $package17->setLink( '/admin/part' );
        // $package17->setHasUniquePartPackage( 1 );
        ...
        $package18->setLink( '/admin/package_group' );
        // $package18->setHasUniquePartPackage( 1 );
        ...
        $package19->setLink( '/admin/package' );
        // $package19->setHasUniquePartPackage( 1 );
        ...
        $package20->setLink( '/admin/sonata/user/group/list' );
        $package20->setHasUniquePartPackage( 1 );
        ...
        // Package 21
        $package21 = new Package();
        $package21->setTitle( 'Utilisateurs' );
        $package21->setDescription( 'Gestion des utilisateurs' );
        $package21->setLink( '/admin/sonata/user/user/list' );
        $package21->setHasUniquePartPackage( 1 );
        $package21->setVersion( '0.0.1' );
        $package21->setIsPublished( 1 );
        $package21->setCreationUserId( $this->getReference('user1') );
        $package21->setModificationUserId( $this->getReference('user1') );
        $package21->setPackageGroupId( $this->getReference('packageGroup11') );

        // Package 22
        $package22 = new Package();
        $package22->setTitle( 'Galerie' );
        $package22->setDescription( 'Gestion de la galerie' );
        $package22->setLink( '/admin/sonata/media/gallery/list' );
        $package22->setHasUniquePartPackage( 1 );
        ...
        $this->addReference('package21', $package21);
